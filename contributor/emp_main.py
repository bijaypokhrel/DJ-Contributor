...
class Ctb_Employer(models.Model):
    ...
    employer_name_nep = models.CharField(
        max_length=150, db_column="EMPLOYER_NAME_NEP")
    employer_name_eng = models.CharField(
        max_length=150, db_column="EMPLOYER_NAME_ENG")
    etype_id = models.DecimalField(
        max_digits=3, decimal_places=0, db_column="ETYPE_ID")  # FK
    stype_id = models.DecimalField(
        max_digits=3, decimal_places=0, db_column="STYPE_ID")  # FK
    e_ssid = models.CharField(max_length=25, db_column="E_SSID")
    entry_by = models.CharField(max_length=30, db_column="ENTRY_BY")
    entry_date = models.DateField(db_column="ENTRY_DATE")
    r_status = models.CharField(max_length=1, db_column="R_STATUS")
    tran_no = models.DecimalField(
    ...
    alt_source_val = models.CharField(
        max_length=100, db_column="ALT_SOURCE_VAL")
    short_menu = models.CharField(max_length=1, db_column="SHORT_MENU")
    calendar = models.CharField(max_length=1, db_column="CALENDAR")
    group_applied = models.CharField(max_length=1, db_column="GROUP_APPLIED")
...
class Ctb_Emp_Doc(models.Model):
    ...
    doc_id = models.DecimalField(
        max_digits=3, decimal_places=0, db_column="DOC_ID")  # PK, AK1, IX1, IX2
    from_date = models.CharField(
        max_length=10, primary_key=True, db_column="FROM_DATE")  # PK, IX1
    to_date = models.CharField(max_length=10, db_column="TO_DATE")
    issue_no = models.CharField(
        max_length=60, db_column="ISSUE_NO")  # AK1, IX2
    issue_date = models.CharField(max_length=10, db_column="ISSUE_DATE")
...
class Ctb_Emp_Official(models.Model):
    ...
    e_id = models.DecimalField(
        max_digits=14, decimal_places=0, db_column="E_ID")  # PFK, IX1
    post_id = models.DecimalField(
        max_digits=10, decimal_places=0, db_column="POST_ID")
    from_date = models.CharField(
        max_length=10, primary_key=True, db_column="FROM_DATE")
    to_date = models.CharField(max_length=10, db_column="TO_DATE")
    entry_by = models.CharField(max_length=30, db_column="ENTRY_BY")
    entry_date = models.DateField(db_column="ENTRY_DATE")
    r_status = models.CharField(max_length=1, db_column="R_STATUS")
