...
class Atb_Gltran_Mast(models.Model):
    ...
    vch_no = models.CharField(null=True, blank=True, max_length=50, db_column="VCH_NO")  # IX1
    ...
    tran_date = models.CharField(null=True, blank=True, max_length=10, db_column="TRAN_DATE")
    tran_user_id = models.CharField(null=True, blank=True, max_length=30, db_column="TRAN_USER_ID")
    is_approved = models.DecimalField(
        null=True, blank=True, max_digits=4, decimal_places=0, db_column="IS_APPROVED")
    approved_date = models.CharField(null=True, blank=True, max_length=10, db_column="APPROVED_DATE")
    ...
    tran_number = models.CharField(null=True, blank=True, max_length=14, db_column="TRAN_NUMBER")
    mast_desc = models.CharField(null=True, blank=True, max_length=1000, db_column="MAST_DESC")
    application_id = models.CharField(
        null=True, blank=True, max_length=20, db_column="APPLICATION_ID")  # FK
    module_id = models.CharField(null=True, blank=True, max_length=30, db_column="MODULE_ID")  # FK
    value_date = models.CharField(null=True, blank=True, max_length=10, db_column="VALUE_DATE")
...
class Atb_Gltran_Detl(models.Model):
    ...
    ac_no = models.CharField(null=True, blank=True, max_length=100, db_column="AC_NO")
    ...
    tran_desc = models.CharField(null=True, blank=True, max_length=200, db_column="TRAN_DESC")
    inst_code = models.CharField(null=True, blank=True, max_length=100, db_column="INST_CODE")
    inst_date = models.CharField(null=True, blank=True, max_length=10, db_column="INST_DATE")
    vch_id = models.DecimalField(
